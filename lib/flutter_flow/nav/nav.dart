...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Chantiers',
          path: '/Chantiers',
          builder: (context, params) => ChantiersWidget(),
        ),
        FFRoute(
          name: 'UnChantier',
          path: '/UnChantier',
          asyncParams: {
            'chantier':
                getDoc(['Entreprise', 'Chantier'], ChantierRecord.fromSnapshot),
          },
          builder: (context, params) => UnChantierWidget(
            chantier: params.getParam(
              'chantier',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          path: '/UneTache',
          asyncParams: {
            'suividechantier': getDoc(['Entreprise', 'SuiviDeChantier'],
                SuiviDeChantierRecord.fromSnapshot),
          },
          builder: (context, params) => UneTacheWidget(
            suividechantier: params.getParam(
              'suividechantier',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'JoinOrCreate',
          path: '/JoinOrCreate',
          builder: (context, params) => JoinOrCreateWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
